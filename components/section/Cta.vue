...
<template>
  <LayoutScrollSmooth>
    ...
    <div class="mesh-gradient flex items-center flex-col rounded-3xl border bg-[#0b061a] border-white/10 p-10 relative">
        ...
        <Button class="mt-10" to="https://wa.me/6281213338952" variant="btn-primary" label="Start Collaboration"/>
        ...
        <p class="text-sm text-white/30 text-center mt-8">&copy; Copyright <NuxtLink to="https://mohamadthoriq.my.id" target="_blank">Rickthor7</NuxtLink> 2025</p>
